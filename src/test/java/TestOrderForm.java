...
import java.util.concurrent.TimeUnit;
    ...
    public class TestOrderForm {
        ...
        public static Object[][] fieldData() {
            return new Object[][]{
                    {0, "Юлия", "Евтеева", "Санкт-Петербург", "Сокол", "89999999999", "10.11.2022", "сутки", "Чёрный", "ничего"},
                    {1, "Иоанн", "Иванов", "Псков", "Перово", "89991234567", "10.12.2022", "семеро суток", "Серый", "не звонить"},
            };
        }
